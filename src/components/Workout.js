                ...
                <table class="table table-bordered">
                    ...
                    {exercises.map(exercise => 
                        <tr>
                            ...
                            <td>
                                <div>
                                <button type="button" class="btn btn-primary btn-block" data-toggle="modal" data-target="#updateExercise">
                                Update
                                </button>
                                </div>
                                
                                <div class="modal fade" id="updateExercise" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action={"/exercises/put/" + exercise._id} method="POST" class="mb-4">
                                ...
                                <form action={"/exercises/delete/" + exercise._id} method="POST" class="mb-4">
